...
class AgendamentoModel {
    constructor({ 
        ...
        this.cli_nome = cli_nome; // Corrigido para usar cli_nome
        this.cli_razao = cli_razao; // Corrigido para usar cli_razao
        this.sal_nome = sal_nome; // Corrigido para usar sal_nome
    }
    ...
    static async verificarDisponibilidade(sala_id, data, horarioInicio, horarioFim) {
        ...
        return results.length === 0; // Retorna true se a sala estiver disponível
    }
// Adicione esta função dentro da classe AgendamentoModel
